...
<script>
  export default {
    ...
    mounted() {
      ...
      Echo.channel(`WholesalerWeekEvent.${this.gameId}`)
        .listen('WholesalerWeekEvent', (e) => {
          this.incoming = true;
          if (this.yourOrder) {
            this.nextWeek();
          } else {
      ...
      Echo.channel(`RetailerInactivePlayer.${this.gameId}`)
        .listen('RetailerInactivePlayer', (e) => {
