...
Route::middleware('auth')->group(function () {
	...
	Route::post('games/{gameId}/retailer/next-week', 'RetailerController@nextWeek')->name('retailer.next-week');
	...
	Route::post('games/{gameId}/wholesaler/next-week', 'WholesalerController@nextWeek')->name('wholesaler.next-week');
	...
	Route::post('games/{gameId}/distributor/next-week', 'DistributorController@nextWeek')->name('distributor.next-week');
	...
	Route::post('games/{gameId}/manufacturer/next-week', 'ManufacturerController@nextWeek')->name('manufacturer.next-week');
